...
var BodegueroRoutingModule = /** @class */ (function () {
    function BodegueroRoutingModule() {
    }
...
var AgregarLocalComponent = /** @class */ (function () {
    function AgregarLocalComponent() {
        this.cFacturacion = [
            {
                id: 1,
    ...
    AgregarLocalComponent.prototype.amenidadChange = function (i, objeto) {
    };
...
var VistaGeneralComponent = /** @class */ (function () {
    function VistaGeneralComponent(router) {
        this.router = router;
    ...
    VistaGeneralComponent.prototype.ngOnInit = function () {
        ...
        fetch(this.conexion + "/api/miniBodegas/getOne/" + this.id)
            ...
            _this.miniBodega = respuesta.content;
            _this.instalaciones = respuesta.content.t_instalaciones;
            console.log(_this.instalaciones);
            _this.rerender();
        });
    };
    VistaGeneralComponent.prototype.ngAfterViewInit = function () {
        this.dtTrigger.next();
    };
    VistaGeneralComponent.prototype.ngOnDestroy = function () {
        // Do not forget to unsubscribe the event
        this.dtTrigger.unsubscribe();
    };
    VistaGeneralComponent.prototype.rerender = function () {
        var _this = this;
    ...
    VistaGeneralComponent.prototype.agregarLocal = function (id) {
        this.router.navigateByUrl('/dashboard/agregarLocal');
        console.log(id);
    };
    VistaGeneralComponent.ctorParameters = function () { return [
...
var AlmacenComponent = /** @class */ (function () {
    function AlmacenComponent(ruta) {
        ...
        fetch(this.conexion + "/api/instalaciones/getOne/" + id)
            ...
            _this.cAcceso = respuesta.content.t_c_acceso;
            _this.cAdministracion = respuesta.content.t_c_administracion;
            _this.cCobertura = respuesta.content.t_c_cobertura;
            _this.cFacturacion = respuesta.content.t_c_facturacion;
            _this.cMudanza = respuesta.content.t_c_mudanza;
            _this.cSeguridad = respuesta.content.t_c_seguridad;
            console.log(_this.almacen);
        });
    }
    AlmacenComponent.prototype.sizing = function (e) {
        var _this = this;
        ...
        if (!this.filtroUnidades[e].enabled) {
            ...
            for (var i = 0; i < this.unidades.length; i++) {
                if (this.unidades[i].areaTotal >= this.filtroUnidades[e].minArea && this.unidades[i].areaTotal <= this.filtroUnidades[e].maxArea) {
                    var index = this.unidadesFiltered.findIndex(function (unidad) { return unidad == _this.unidades[i]; });
                    console.log(this.unidadesFiltered.findIndex(function (unidad) { return unidad == _this.unidades[i]; }));
...
var BusquedaComponent = /** @class */ (function () {
    ...
    BusquedaComponent.prototype.filterChange = function (index) {
        ...
        if (this.amenidades[0].valor == 0 && this.amenidades[1].valor == 0 && this.amenidades[2].valor == 0 && this.filtroTamaño == true) {
            ...
            fetch(this.conexion + "/api/instalaciones/medidas/" + this.maxLng + "/" + this.minLng + "/" + this.maxLat + "/" + this.minLat + "/" + this.minTamaño + "/" + this.maxTamaño)
                ...
                var lat = _this.lat;
                var lng = _this.lng;
                for (var i = 0; i < respuesta.content.length; i++) {
                    var element = respuesta.content[i];
                    ...
                    _this.almacenes.push(element);
                    // this.almacenes.push(obj)
                    // console.log(element)
                }
                _this.mapaService.setProperties(_this.almacenes);
            });
        }
        else {
    ...
    BusquedaComponent.prototype.ngOnInit = function () {
        ...
        this.mapaService.getLatLng().subscribe(function (respuesta) {
            console.log(respuesta);
            _this.recenterMap(respuesta.lat, respuesta.lng);
            _this.mapaSeteado = true;
                        ...
                        autocompleteService.getPlacePredictions({
                            ...
                            if (list == null || list.length == 0) {
                                ...
                                placesService.getDetails({ placeId: list[0].reference }, function (detailsResult, placesServiceStatus) {
                                    ...
                                    _this.lat = detailsResult.geometry.location.lat();
                                    _this.lng = detailsResult.geometry.location.lng();
                                    _this.mapaService.setLatLng(_this.lat, _this.lng);
                                });
                            }
                        });
